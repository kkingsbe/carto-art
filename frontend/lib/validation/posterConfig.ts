...
export const PosterConfigSchema: z.ZodType<PosterConfig> = z.object({
  ...
  typography: z.object({
    ...
    subtitleWeight: z.number().min(0).max(900).optional(),
  ...
  layers: z.object({
    ...
    parks: z.boolean(),
    terrain: z.boolean(),
    terrainUnderWater: z.boolean().default(false),
    hillshadeExaggeration: z.number().default(1.0),
    contours: z.boolean(),
    contourDensity: z.number().default(1.0),
    ...
    labelAdminSize: z.number().optional(),
    'labels-cities': z.boolean().optional(),
    labelCitiesSize: z.number().optional(),
    boundaries: z.boolean().optional(),
    marker: z.boolean(),
    markerType: z.enum(['pin', 'crosshair', 'dot', 'ring', 'heart', 'home']).optional(),
    markerColor: z.string().optional(),
    roadWeight: z.number().default(1.0),
    // Landcover layers
    landcoverWood: z.boolean().optional(),
    landcoverGrass: z.boolean().optional(),
    landcoverFarmland: z.boolean().optional(),
    landcoverIce: z.boolean().optional(),
    // Landuse layers
    landuseForest: z.boolean().optional(),
    landuseOrchard: z.boolean().optional(),
    ...
    railroads: z.boolean().default(false),
  }),
  rendering: z.object({
