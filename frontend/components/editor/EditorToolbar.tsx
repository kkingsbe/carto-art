...
export function EditorToolbar({
    ...
    return (
        <div className="absolute top-2 right-2 md:top-6 md:right-8 z-50 pointer-events-auto flex items-center gap-2 md:gap-3 flex-wrap justify-end max-w-[calc(100vw-4rem)]">
            {/* History Controls */}
