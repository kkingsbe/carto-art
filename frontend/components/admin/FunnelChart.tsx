            ...
            <div className="space-y-4 relative">
                {data.map((step, index) => (
                    <div key={step.step} className="relative z-10">
                        ...
                        <div className="h-8 flex bg-gray-100 dark:bg-gray-800 rounded-md overflow-hidden relative group">
                            <div
                        ...
                        {index < data.length - 1 && (
                            <div className="pl-4 py-1 flex items-center gap-2 text-[10px] text-red-500 font-medium">
